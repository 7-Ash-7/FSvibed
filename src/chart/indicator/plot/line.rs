...
pub struct LinePlot<V, T> {
    ...
    pub color_override: Option<iced::Color>,
...
impl<V, T> LinePlot<V, T> {
    ...
    pub fn line_color(mut self, color: iced::Color) -> Self {
    ...
    V: Fn(&S::Y) -> f32,
{
    ...
    fn draw(
        ...
        let color = self.color_override.unwrap_or(palette.secondary.strong.color);
