    ...
    let content = match kind {
        KlineChartKind::Candles => {
            ...
            let cvd_section = {
                ...
                let period_slider = if cfg.cvd.ema_mode {
                    let period = cfg.cvd.ema_period.clamp(2, 200);
                    Some(classic_slider_row(
                        text("EMA period"),
                        slider(2u32..=200, period, move |v| {
                            Message::VisualConfigChanged(
                                pane,
                                VisualConfig::Kline(data::chart::kline::Config {
                        ...
                        .step(1u32)
                        .into(),
                        Some(text(format!("{}", cfg.cvd.ema_period)).size(13)),
                    ))
                } else {
                    None
                };
