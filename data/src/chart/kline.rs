...
pub enum ClusterBarStyle {
    #[default]
    Bars,
    Heatmap,
}
impl ClusterBarStyle {
    pub const ALL: [ClusterBarStyle; 2] = [ClusterBarStyle::Bars, ClusterBarStyle::Heatmap];
}
impl std::fmt::Display for ClusterBarStyle {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ClusterBarStyle::Bars => write!(f, "Bars"),
            ClusterBarStyle::Heatmap => write!(f, "Heatmap"),
        }
    }
}
...
impl TickGrouping {
    ...
    pub fn multiplier(self) -> u32 {
        match self {
            ...
            TickGrouping::T20   =>   20,
            TickGrouping::T50   =>   50,
            TickGrouping::T100  =>  100,
            TickGrouping::T250  =>  250,
            TickGrouping::T500  =>  500,
            TickGrouping::T750  =>  750,
            TickGrouping::T1000 => 1000,
        }
    }
}
...
pub struct VolumeProfileConfig {
    ...
    /// Maximum width of the profile as a multiple of cell_width.
    /// Default 12. Increase for wider markets (e.g. high-value assets).
    #[serde(default = "default_vp_max_width")]
    pub max_width_cells: u8,
}
fn default_vp_max_width() -> u8 { 12 }
